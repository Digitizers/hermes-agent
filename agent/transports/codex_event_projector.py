...
class CodexEventProjector:
    ...
    def project(self, notification: dict) -> ProjectionResult:
        ...
        if item_type == "reasoning":
            ...
            # Reasoning proves Codex is still advancing the turn. Keep it out
            # of durable messages/final output, but clear the silence watchdog.
    ...
    def _project_agent_message(self, item: dict) -> ProjectionResult:
        ...
        # become durable assistant output or satisfy the final-response contract.
